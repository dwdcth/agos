...
- [x] **Phase 6: Runtime Gate Enforcement** - 让 readiness/doctor 规则真正约束 `ingest`、`search`、`agent-search` 等运行入口
- [x] **Phase 7: Follow-up Evidence Integration** - 让 agent-search 的 follow-up retrieval 真实进入 working memory 与 decision 流
...
| 6. Runtime Gate Enforcement | 2/2 | Complete | 2026-04-16 |
| 7. Follow-up Evidence Integration | 2/2 | Complete | 2026-04-16 |
